...
export type Appointment = { id: string; organization_id: string; organization_name: string | null; location_id: string | null; location_name: string | null; room_id: string | null; room_name: string | null; practitioner_id: string; practitioner_name: string | null; practitioner_service_id: string; practitioner_service_name: string | null; patient_id: string; patient_name: string | null; starts_at: string; ends_at: string; status: string; status_label: string; notes: string | null; modality: 'in_person' | 'virtual'; virtual_meeting_url: string | null; virtual_meeting_id: string | null; virtual_access_code: string | null; virtual_link_status: string; virtual_link_created_mode: string | null; virtual_link_provider: string | null; virtual_link_sent_at: string | null; created_at: string | null; updated_at: string | null };
export type CreateAppointmentPayload = { organization_id: string; location_id: string; room_id?: string | null; practitioner_id: string; practitioner_service_id: string; patient_id: string; starts_at: string; ends_at: string; notes?: string | null; virtual_meeting_url?: string | null; virtual_meeting_id?: string | null; virtual_access_code?: string | null };
export type PatchAppointmentPayload = { starts_at?: string; ends_at?: string; room_id?: string | null; notes?: string | null; virtual_meeting_url?: string | null; virtual_meeting_id?: string | null; virtual_access_code?: string | null; virtual_link_status?: string | null; virtual_link_created_mode?: string | null; virtual_link_provider?: string | null };
...
export type PaymentFilters = { organization_id?: string; status?: string; method?: string; date_from?: string; date_to?: string; patient?: string; booking_id?: string; practitioner_id?: string };
const paymentQuery = (filters: PaymentFilters = {}) => { const params = new URLSearchParams(); Object.entries(filters).forEach(([key, value]) => { if (value) params.set(key, value); }); const query = params.toString(); return `/api/admin/payments${query ? `?${query}` : ''}`; };
export const adminPaymentsApi = {
  listPayments: (tenantId: string, filters: PaymentFilters = {}) => apiRequest<AdminPayment[]>(paymentQuery(filters), { tenantId }),
