...
from app.tenancy.schema import (
    ...
    apply_booking_notes_tenant_migration,
    apply_semantic_documents_tenant_migration,
...
TENANT_MIGRATIONS: tuple[PendingTenantMigration, ...] = (
    ...
    PendingTenantMigration("009_semantic_documents", apply_semantic_documents_tenant_migration),
)
